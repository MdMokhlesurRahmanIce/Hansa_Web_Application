<%@ Page Title="" Language="C#" MasterPageFile="~/SiteHome.Master" AutoEventWireup="true" CodeBehind="Objective.aspx.cs" Inherits="Hansa.Web.Objective" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
           ...
           // var viewableOffset = $('#hsForMainSliders').offset().top * 3 - 60 + $('#ContentPlaceHolder1_backgrnd').height() + $('#backgroundTxt').height() + $('#blnkRow').height();// + $("#bdyhdr").height();//$('#ContentPlaceHolder1_backgrnd').offset().top + $('#ContentPlaceHolder1_backgrnd').outerHeight(true);//$('#ContentPlaceHolder1_backgrnd').position().top;
            ...
            //collapseTwo id="collapseOne" class="panel-collapse collapse in"
            $('#collapseOne2').removeClass("panel-collapse collapse in");
            $('#collapseOne2').addClass("panel-collapse collapse");
            $('#collapseOne2').attr("aria-expanded", "false");
            $("#headingOne2 h4 a").attr("aria-expanded", "false");
            $('#headingOne2 h4 a').addClass("collapsed");
            // class="collapsed"

            $('#collapseOne1').removeClass("panel-collapse collapse");
            $('#collapseOne1').addClass("panel-collapse collapse in");
            $('#collapseOne1').attr("aria-expanded", "true");
            // aria-expanded="true"
            $('#headingOne1 h4 a').removeClass("collapsed");
            $('#headingOne1 h4 a').attr("aria-expanded", "true");

            $('#collapseOne3').removeClass("panel-collapse collapse in");
            $('#collapseOne3').addClass("panel-collapse collapse");
            $('#collapseOne3').attr("aria-expanded", "false");
            $("#headingOne3 h4 a").attr("aria-expanded", "false");
            $('#headingOne3 h4 a').addClass("collapsed");

            $('#collapseOne4').removeClass("panel-collapse collapse in");
            $('#collapseOne4').addClass("panel-collapse collapse");
            $('#collapseOne4').attr("aria-expanded", "false");
            $("#headingOne4 h4 a").attr("aria-expanded", "false");
            $('#headingOne4 h4 a').addClass("collapsed");
                ...
                <div class="container"> 
                        ...
                        <div class="row" id="backgroundTxt">
                            <div class="col-sm-12" style="text-align: justify;">
                                ...
                                <p>
                                    Reflection of the economical upsurge of Bangladesh is clearly visible even in the life-styles and standards of individuals. 
                                The peoples are considered as international customers even sometimes as commodity. Social, Industrial, Infrastructural, Technological, 
                                Information Technological and other Developments lead to global presence of Bangladesh. Property value is one aspect and helps us to assess 
                                such advancement.Property has been considered as most expensive product in Bangladesh since long. In Dhaka and other megacities of Bangladesh 
                                the escalation is going on day by day. Similarly in other megacities like Chittagong, Sylhet, the people are coming for a better life-style and 
                                facilities. Over 40 millions of people are residing in those three megacities which is about 25% of the total population of the country. 
                                Obviously the demand in housing is excessively high and the people are ready to sacrifice all their earnings to have a shelter. Similarly the 
                                Corporate Business Sector, Healthcare, Hotels and Tourism, Educations, FMCG etc. are trying to offer a healthy atmosphere to its employees, customers.
                                Compared to all other developments, the representation of the property is not satisfactory so far. The expectation and customers demand is so 
                                high but the commitment and service standards are not developed up to the desired level. That is very warning side where millions of millions 
                                amount of money has been invested. To keep the trends of increasing value of the property, the service and maintenance is very crucial.  
                                In consequences to the UG operations, HANSA Management Limited is formed by UG to offer an international standard Facilities Management (FM) 
                                to ensure an iconic life-style. International Standard FM Service is designed and practiced in Bangladesh ensuring with highest passion and 
                                ...
                                <div class="panel-group" id="accordion1" role="tablist" aria-multiselectable="true">
                                    ...
                                    <div class="panel">
                                        ...
                                        <div style="" aria-expanded="false" id="collapseOne2" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne2">
                                            <div class="panel-body">
                                                <div>
                                                    <p><span>To establish an international standard FM  Organization  in Bangladesh.</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div style="" aria-expanded="false" id="collapseOne4" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne4">
                                            <div class="panel-body">
                                                ...
                                                <div>
                                                    <p><span>To optimum use of resources for carrying out the business operation with ensuring customer satisfaction.</span></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4" style="background: #fff none repeat scroll 0 0; border-bottom: medium none; height: 200px;">
                                ...
                                <p style="text-align: justify;">
                                    The environment is our life long shelter and HANSA will never act anything harmful to the nation and earth. We are committed to serve you through ensuring green environment. HANSA is trying its level best to protect the interest of yours and the environment as well. HANSA is created for helping others and our philosophy will be remained as long as we can. 
                                </p>
                            </div>
                            <div class="col-lg-4">
