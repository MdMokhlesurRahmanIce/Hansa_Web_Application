<%@ Page Title="" Language="C#" MasterPageFile="~/SiteHome.Master" AutoEventWireup="true" CodeBehind="CSR.aspx.cs" Inherits="Hansa.Web.CSR" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
           ...
           // var viewableOffset = $('#hsForMainSliders').offset().top * 3 - 60 + $('#ContentPlaceHolder1_backgrnd').height() + $('#backgroundTxt').height() + $('#blnkRow').height() + $('#allcolapseblePanel').height();// + $("#bdyhdr").height();//$('#ContentPlaceHolder1_backgrnd').offset().top + $('#ContentPlaceHolder1_backgrnd').outerHeight(true);//$('#ContentPlaceHolder1_backgrnd').position().top;
            ...
            var viewableOffset = topber + headerber + hsTopMainslider + $('#ContentPlaceHolder1_backgrnd').height() + $('#backgroundTxt').height() + $('#blnkRow').height() + $('#allcolapseblePanel').height()-30;

            // alert(viewableOffset);

            $('html,body').animate({ scrollTop: viewableOffset+'px' }, 'slow'); 
